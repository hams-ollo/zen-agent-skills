...
audited: 2026-08-05
revised: 2026-08-05 (bug-0014, S-011 row only; the audit itself was not re-run)
---
...
contract-lagging-implementation divergence. That ratio is worth stating because it is the argument
