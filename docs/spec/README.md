...
| [`cloud-executable`](cloud-executable.md) | **draft** | 18 | none yet |
...
Ten specs, 136 scenarios. The nine approved ones carry 118 of those and every one has a conformance
